...
These instructions apply to the entire `abdulbasit742/ai-extensions` repository. More specific AGENTS.md or AGENTS.override.md files in subdirectories may refine them.

Project: **ARIA AI Extensions**.
